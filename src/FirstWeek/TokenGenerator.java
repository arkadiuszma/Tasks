...
public class TokenGenerator {
        ...
        while (true) {
            try {
                ...
                switch (numberOfChars) {
                    ...
                    default -> System.out.println("Number you entered isn't 5, 10 or 15. Please enter correct number.");
                }
    ...
    private static int validCharactersNumber() {
        while (true) {
            ...
            if (randomNumber == 33 || 35 <= randomNumber && randomNumber <= 38 || 40 <= randomNumber && randomNumber <= 42 ||
